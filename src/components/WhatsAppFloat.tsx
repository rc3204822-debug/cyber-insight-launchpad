    ...
    <>
      ...
      {isVisible && (
        <div className="fixed bottom-24 right-6 z-40">
          <div className="bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg text-sm font-medium animate-bounce">
            <div className="flex items-center space-x-2">
              <Phone className="w-4 h-4" />
              <span>Consulta GRÁTIS no WhatsApp!</span>
            </div>
            <div className="absolute bottom-0 right-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-green-500 transform translate-y-full"></div>
          </div>
        </div>
      )}
    </>
